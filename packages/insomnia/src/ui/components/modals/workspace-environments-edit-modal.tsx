          ...
          {({ close }) => (
            <div className='flex-1 flex flex-col gap-4 overflow-hidden h-full'>
                    ...
                    return (
                      ...
                      >
                        <div className={`${item.parentId === workspaceId ? 'pl-4' : 'pl-8'} pr-4 flex select-none outline-none group-aria-selected:text-[--color-font] relative group-hover:bg-[--hl-xs] group-focus:bg-[--hl-sm] transition-colors gap-2 items-center h-[--line-height-xs] w-full overflow-hidden text-[--hl]`}>
                          ...
                          />
                          <div className='items-center truncate justify-center data-[pressed]:bg-[--hl-sm] rounded-sm text-[--color-font] hover:bg-[--hl-xs] focus:ring-inset ring-1 ring-transparent focus:ring-[--hl-md] transition-all px-1 flex-1 hover:!bg-transparent'>
                            {item.name}
                          </div>
              ...
              <div className='flex items-center gap-2 justify-between'>
                ...
                <Button
                  onPress={close}
                  className="py-3 px-7 bg-[--color-surprise] text-[--color-font-surprise] transition-colors rounded"
                >
                  Done
                </Button>
              </div>
